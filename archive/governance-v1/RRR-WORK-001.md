...
- **Acceptance:**
  - No lint regressions
  - No stale references to archived/deleted files
...
- **Scope:**
  ...
  - All assertions must pass on current `main` without modifying `LedgerService`
...
PROGRAM_CONTROL/REPORT_BACK/RRR-WORK-001-<task-id>-report.md
```

The agent then amends §6 of this charter in the same PR:
