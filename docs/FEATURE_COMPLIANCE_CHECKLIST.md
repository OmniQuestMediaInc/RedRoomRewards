...
This checklist ensures that all new feature modules comply with the established
wallet and escrow architecture. Features that fail this checklist must not be
deployed to production.

**Reference**: See `/docs/WALLET_ESCROW_ARCHITECTURE.md` for detailed
architecture.
...
**This checklist is authoritative. All new features must comply before
