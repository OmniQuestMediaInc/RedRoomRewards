...
- All design decisions go in `docs/DECISIONS.md`; all major architectural
  choices/logs in `ARCHITECTURE.md`.
...
- Treat tokens like cash (see Security Policy); never allow unguarded client
  control, ensure idempotency and atomicity on all mutations.
