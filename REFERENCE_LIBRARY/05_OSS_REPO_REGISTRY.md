...
Registry of all open-source repositories harvested as reference branches in this
repo. All entries are MIT or ISC licensed unless noted. Patterns are adapted
only — no source code is incorporated into RRR directly.
